  ...
  try {
    ...
    if (!newResource) {
      return NextResponse.json(
        { message: "Failed to create resource!", success: false },
        { status: 500 }
      );
    }
    ...
    return NextResponse.json(
      { message: "Failed to create resource!", success: false, error: error },
      { status: 500 }
    );
  }
}
...
export async function GET() {
  try {
    ...
    if (resources.length === 0) {
      return NextResponse.json(
        { message: "No resources found!", success: false },
        { status: 404 }
      );
    }
    ...
    return NextResponse.json(
      { message: "Failed to fetch resources!", success: false, error: error },
      { status: 500 }
    );
  }
}
